...
\begin{section}{Auction Algorithms}
	...
	\begin{subsection}{The Naive Algorithm}
		...
		largest 
		amount that still maintains the fact that $g^{*}$ offers maximal value to $b$. We can 
		...
		profit of the best object and the profit of the second best object for the current 
		bidder. That is the essence of the naive algorithm: choose an unassigned bidder $b$, find 
		an item that maximizes their individual value, bump the price of that good by 
		$\delta_b$, and unassign the previous owner. We do this until all bidders are assigned.
