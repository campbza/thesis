...
\begin{section}{Linear programming}
	...
	easily transcribable into the linear programming formulation. Our goal in this section will 
	...
	\begin{alignat}{3}
		...
		& \text{subject to } \quad & \sum_{j} x_{ij} & \leq 1, & \quad \forall i &, \\
				     &\quad & \sum_{i} x_{ij} & \leq 1, & \quad \forall j &, \\
				&& x_{ij} & \in \{0,1\}.
	\end{alignat}

	%Minimum vertex cover ILP%
